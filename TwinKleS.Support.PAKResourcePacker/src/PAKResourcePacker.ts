/** PAK资源打包 */
namespace TwinKleS.Support.PAKResourcePacker {

	// ------------------------------------------------

	/**
	 * 将资源目录内的所有文件打包为PAK数据包
	...
	export function pack(
		...
		let manifest_js: Core.Tool.Package.PAK.Information.JS_N.Package = {
			version: 0n,
			resource: []
		};
		...
		let manifest = Core.Tool.Package.PAK.Information.Package.json(Core.JSON.Value.value(manifest_js));
